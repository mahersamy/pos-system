...
export const MENU_TABLE_ACTION_META: Omit<ActionConfig, "func">[] = [
    { icon: "fa-solid fa-pen-to-square", classes: "edit-button", permission: { module: PermissionModule.MENU, action: 'write' } },
    { icon: "fa-solid fa-trash", classes: "delete-button", permission: { module: PermissionModule.MENU, action: 'delete' } },
];
